...
public class CustomerVehicleMappingServiceTest {
    ...
    public void getCustomersByVehicle() {
        ...
        Mockito.when(customerVehicleMappingRepository.findCustomersByVehicle(vehicle)).thenReturn(Collections.singletonList(customer));

        List<Customer> customers = customerVehicleMappingService.getCustomersByVehicle(vehicle);
